...
public class GraphicalPlanet extends Sphere implements SpaceObject {
    ...
    public GraphicalPlanet(double px, double py, double pz, double vx, double vy, double vz, double mass, double radius) {
