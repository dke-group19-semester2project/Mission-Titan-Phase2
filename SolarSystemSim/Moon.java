...
public class Moon extends Sphere implements SpaceObject {
    ...
    public Moon(double px, double py, double pz, double vx, double vy, double vz, double mass,double radius) {
