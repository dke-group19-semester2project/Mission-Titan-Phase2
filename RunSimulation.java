public class RunSimulation {
    ...
    public static void displayInternalSimulation () {
        ...
        SimulationBody probe = new SimulationBody(new Vector2D(startingDistance,0), new Vector2D(0, orbitalSpeed/*1600*/), 5000, 1, new WindSpeed(1));
    ...
    public static void displayOpenLoopSimulation () {
        ...
        SimulationBody realProbe = new SimulationBody(new Vector2D(startingDistance,0), new Vector2D(0, orbitalSpeed),
